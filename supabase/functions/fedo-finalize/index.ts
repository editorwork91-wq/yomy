...
Deno.serve(async req => {
  ...
  const thumbnailShardRaw = body?.thumbnail_shard
  const thumbnailShard = typeof thumbnailShardRaw === 'number' && Number.isInteger(thumbnailShardRaw) ? thumbnailShardRaw : videoShard
