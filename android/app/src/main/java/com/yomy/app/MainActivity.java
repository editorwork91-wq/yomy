...
public class MainActivity extends BridgeActivity {
    ...
    private final class LocalNotificationBridge {
        ...
        @JavascriptInterface public void startActiveCall(String title, String callId, String kind, String route) { runOnUiThread(() -> CallNotificationService.startActive(MainActivity.this, callId, title, kind, route)); }
