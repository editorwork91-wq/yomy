...
public class CallNotificationService extends Service {
    ...
    private Notification buildNotification(String title, String body, String kind, String callId) {
        ...
        // Tapping the notification is an explicit "open" action: stop the ringing
        // service first, then bring the real Yomy MainActivity to the foreground.
        // Do not launch IncomingCallActivity here; the WebView owns the call UI.
        PendingIntent incomingScreen = PendingIntent.getBroadcast(
                this,
                41005,
                actionIntent(CallActionReceiver.ACTION_OPEN, callId),
                flags
        );
        ...
        builder.setSmallIcon(R.mipmap.ic_launcher)
                ...
                .setShowWhen(true)
                .setContentIntent(incomingScreen);
