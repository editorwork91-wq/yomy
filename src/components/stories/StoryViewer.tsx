...
import { X, Send, Eye, Trash2, MoveVertical as MoreVertical } from 'lucide-react'
      ...
      <div className="relative w-full max-w-sm h-full">
          ...
          {isOwner && (
            <DropdownMenu>
              <DropdownMenuTrigger asChild>
                <Button variant="ghost" size="icon" className="text-white hover:bg-white/20 size-8">
                  <MoreVertical className="size-5" />
                </Button>
              </DropdownMenuTrigger>
              <DropdownMenuContent align="end">
                <DropdownMenuItem onClick={loadViewers}>
                  <Eye className="size-4 mr-2" /> View viewers
                </DropdownMenuItem>
                <DropdownMenuItem onClick={deleteStory} className="text-destructive focus:text-destructive">
        ...
        {currentStory.caption && (
          <div className="absolute bottom-24 left-0 right-0 px-4">
            <p className="text-white text-sm drop-shadow-lg">{currentStory.caption}</p>
          </div>
        )}
