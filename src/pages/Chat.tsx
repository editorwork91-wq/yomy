...
export default function Chat() {
    ...
    try {
      ...
      if (insertedMessage) {
        setMessages(prev => prev.some(m => m.id === insertedMessage.id) ? prev : [...prev, {
          ...
          is_seen: false, delivered_at: null, is_encrypted: true, view_once: viewOnceMode, view_once_opened: false, deleted_at: null, deleted_for_everyone: false,
  ...
  const sendTextMessage = async () => {
    ...
    try {
      ...
      if (insertedMessage) {
        setMessages(prev => prev.some(m => m.id === insertedMessage.id) ? prev : [...prev, {
          id: insertedMessage.id, sender_id: user.id, receiver_id: otherUser.id, content: newMessage.trim(), media_url: '', media_type: '', is_seen: false, delivered_at: null, is_encrypted: true,
