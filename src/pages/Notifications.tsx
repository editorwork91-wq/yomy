...
export default function Notifications() {
  ...
  const refreshNotifications = useCallback(async () => { await fetchNotifications() }, [fetchNotifications])
  const { pullDistance, refreshing } = usePullToRefresh(refreshNotifications)
