...
export type Message = { id: string; sender_id: string; receiver_id: string; content: string; media_url: string; media_type: '' | 'image' | 'video' | 'audio'; is_seen: boolean; delivered_at: string | null; is_encrypted: boolean; view_once: boolean; view_once_opened: boolean; deleted_at: string | null; deleted_for_everyone: boolean; reply_to_id: string | null; edited_at: string | null; is_request: boolean; request_accepted: boolean; created_at: string; sender?: Profile; receiver?: Profile; reply_to?: Message; message_reactions?: MessageReaction[] }
